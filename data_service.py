...
# Upstox per-request date range limit
# Momentum screener needs max 12M data — we fetch 14M to be safe
UPSTOX_MAX_LOOKBACK_MONTHS = 120  # 10 years = 120 months (Upstox daily limit)
